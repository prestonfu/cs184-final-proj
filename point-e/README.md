...
# Usage for the sake of this project

All of our scripts and data are in [point_e/examples](point_e/examples). Notably, we provide some updates in [image2pointcloud.ipynb](point_e/examples/image2pointcloud.ipynb), as well as inference functionality for stable diffusion and Dalle-3. The prompts and image urls in [web_images.csv](point_e/examples/web_images.csv) were manually collected, whereas the prompts in [stable_diffusion_prompts.txt](point_e/examples/stable_diffusion_prompts.txt) were generated by Claude 3.
